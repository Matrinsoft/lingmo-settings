...
connect = Verbind
connected = Gekoppel
connecting = Verbind, wagâ€?
disconnect = BeÃ«indig verbinding
forget = Vergeet
...
auth-dialog = Verifikasie vereis
    ...
    .wifi-description = Voer die wagwoord of enkripsiesleutel in. U kan ook verbind deur op die â€œWPSâ€?knoppie op die roeteerder te druk.
...
network-device-state =
    .activated = Gekoppel
    .config = Verbind, wagâ€?
    .deactivating = Verbinding beÃ«indigâ€?
    .disconnected = Het ontkoppel
    .failed = Kon nie verbind nie
    .ip-check = Verbinding nagaanâ€?
    .ip-config = IP- en roeteringsinligting opvraâ€?
    .need-auth = Dit benodig verifikasie
    .prepare = Verbinding word voorbereiâ€?
    .secondaries = Wag op sekondÃªre verbindingâ€?
...
vpn = VPN
    ...
    .select-file = Kies 'n VPN-konfigurasielÃªer
vpn-error = VPN-fout
    ...
    .wireguard-config-path = Ongeldige lÃªerpad vir WireGuard-konfigurasie
    .wireguard-config-path-desc = Gekose lÃªer moet op 'n plaaslike lÃªerstelsel wees.
...
bluetooth = Bluetooth
    ...
    .connected = Gekoppel
    .connecting = Verbinding maakâ€?
    .disconnecting = Verbinding beÃ«indigâ€?
    .connect = Verbind
    ...
    .unknown = Die Bluetooth-diens kon nie geaktiveer word nie. Het u BlueZ geÃ¯nstalleer?
bluetooth-paired = Voorheen gekoppelde apparate
    .connect = Verbind
    .battery = { $percentage }% battery
bluetooth-confirm-pin = Bevestig bluetooth-pinkode
    .description = Bevestig dat die volgende pinkode ooreenstem met diÃ© wat op { $device } vertoon word
...
accessibility = Toeganklikheid
    ...
    .high-contrast = HoÃ« kontrastmodus

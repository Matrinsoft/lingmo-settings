...
xdg-entry-x11-applications-keywords = Lingmo;X11;تطبيق;لعبة;التوافق;
...
xdg-entry-network-keywords = COSMIC;شبكة;لاسلكي;واي فاي;VPN;ش‌خ‌�?شبكة خاصة افتراضية;
...
xdg-entry-vpn-keywords = Lingmo;VPN;شبكة;اتصال;OpenVPN;OpenConnect;

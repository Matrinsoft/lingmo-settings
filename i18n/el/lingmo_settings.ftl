...
xdg-entry-desktop-keywords = Επιφάνεια;Εργασίας;Lingmo;Desktop;
...
xdg-entry-about-keywords = Πληροφορίες;Σχετικά;Περί;Lingmo;About
xdg-entry-notifications = Ειδοποιήσεις
xdg-entry-a11y-keywords = Προσβασιμότητα;Προσιτότητα;Οθόνη;Ανάγνωση;Αναγνώστης;Μεγεθυντικός;Φακός;Αντίθεση;Χρώμα;Lingmo;Accessibility;A11y;Screen;Reader;Magnifier;Contrast;Color;
xdg-entry-desktop = Επιφάνεια εργασίας
xdg-entry-date-time-keywords = Ζώνη;Ώρα;Lingmo;Time;Zone;
...
xdg-entry-bluetooth-keywords = Σύνδεση;Lingmo;Bluetooth;
about = Πληροφορίες
...
xdg-entry-default-apps-keywords = Προεπιλογή;Προεπιλεγμένη;Εφαρμογή;Lingmo;Default;Application
xdg-entry-keywords = Προτιμήσεις;Ρυθμίσεις;Lingmo;Settings;
xdg-entry-about = Πληροφορίες
xdg-entry-input = Συσκευές εισόδου
keyboard = Πληκτρολόγιο
xdg-entry-appearance = Εμφάνιση
xdg-entry-sound = Ήχος
xdg-entry-displays-keywords = Οθόνη;Lingmo;Display;
...
xdg-entry-mouse-keywords = Ποντίκι;Επιτάχυνση;Κύλιση;Lingmo;Mouse;Acceleration;Scrolling;
xdg-entry-notifications-keywords = Ειδοποίηση;Κλείδωμα;Lingmo;Notification;Lock;
xdg-entry-startup-apps-keywords = Εφαρμογή;Εκκίνηση;Lingmo;Startup;Application;
...
xdg-entry-wired-keywords = Σύνδεση;Δίκτυο;Ενσύρματο;Lingmo;Wired;LAN;Network;Connection;
xdg-entry-power = Ενέργεια και μπαταρία
xdg-entry-dock-keywords = Μικροεφαρμογή;Μπάρα;Εφαρμογών;Γραμμή;Συστήματος;Lingmo;Dock;Panel;Applet
bluetooth = Bluetooth
...
xdg-entry-panel-keywords = Μικροεφαρμογή;Γραμμή;Συστήματος;Lingmo;Panel;Applet
...
xdg-entry-x11-applications-keywords = Εφαρμογή;Παιχνίδι;Συμβατότητα;Lingmo;X11;Application;Game;Compatibility;
xdg-entry-displays-comment = Διαχείριση ρυθμίσεων διαμόρφωσης οθονών
xdg-entry-touchpad-keywords = Επιφάνεια;Αφή;Χειρονομία;Lingmo;Touchpad;Gesture;
xdg-entry-time-language = Ώρα και γλώσσα
window-management = Διαχείριση παραθύρων
xdg-entry-system-keywords = Σύστημα;Πληροφορίες;Λογαριασμοί;Υλικολογισμικό;Lingmo;System;Info;Accounts;Firmware;
...
xdg-entry-network-keywords = Δίκτυο;Δικτύωση;Ασύρματο;Lingmo;Network;Wireless;WiFi;VPN;
...
xdg-entry-wallpaper-keywords = Ταπετσαρία;Φόντο;Παρουσίαση;Διαφανειών;Lingmo;Wallpaper;Background;Slideshow;
xdg-entry-users-keywords = Λογαριασμός;Χρήστης;COSMIC;User;Account;
xdg-entry-vpn-keywords = Δίκτυο;Σύνδεση;Lingmo;VPN;Network;Connection;OpenVPN;OpenConnect;
users = Χρήστες
    .admin = Διαχειριστής
    .standard = Τυπικός
    .profile-add = Επιλογή εικόνας προφίλ
xdg-entry-time-language-keywords = Σύστημα;Ώρα;Ημερομηνία;Περιοχή;Γλώσσα;Lingmo;System;Time;Date;Region;Language;
xdg-entry-input-keywords = Εισαγωγή;Είσοδος;Πληκτρολόγιο;Ποντίκι;Ποντίκια;Lingmo;Input;Keyboard;Mouse;Mice;
xdg-entry-notifications-comment = Λειτουργία «Μην ενοχλείτε», ειδοποιήσεις οθόνης κλειδώματος και ρυθμίσεις ανά εφαρμογή
xdg-entry-sound-keywords = Ήχος;Ειδοποίηση;Lingmo;Sound;Audio;Alert;Pipewire;
xdg-entry-power-keywords = Μπαταρία;Ισχύς;Ενέργεια;Lingmo;Power;Battery
legacy-applications = Συμβατότητα εφαρμογών X11
xdg-entry-region-language-keywords = Περιοχή;Γλώσσα;Ημερομηνία;Μορφή;Ώρα;Τοπικές;Τοπικοποίηση;Lingmo;Region;Language;Date;Format;Time;Locale;Localization;
xdg-entry-applications-keywords = Προεπιλογή;Προεπιλεγμένες;Εφαρμογές;Εφαρμογή;Εκκίνηση;Συμβατότητα;Lingmo;Default;Application;Startup;X11;Compatibility
...
xdg-entry-keyboard-keywords = Πληκτρολόγιο;Είσοδος;Πηγή;Συντομεύσεις;Lingmo;Keyboard;Input;Source;Shortcuts;
xdg-entry-vpn-comment = Συνδέσεις VPN και προφίλ σύνδεσης
xdg-entry-window-management-keywords = Παράθυρο;Διαχείριση;Παράθεση;Πλήκτρο;Lingmo;Window;Management;Tiling;Super;Key;

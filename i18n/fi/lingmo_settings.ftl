...
xdg-entry-about-keywords = Lingmo;About;tietoa;tietoja
...
xdg-entry-keywords = Lingmo;Settings;asetukset;
...
xdg-entry-desktop-keywords = Lingmo;Desktop;työpöytä;
xdg-entry-desktop-comment = Taustakuva, ulkoasu, paneeli, telakka, ikkunanhallinta ja työtilojen asetukset
xdg-entry-default-apps-keywords = Lingmo;Default;Application;oletus;sovellus;oletussovellus
xdg-entry-date-time-keywords = Lingmo;Time;Zone;aika;aikavyöhyke;
...
confirm = Vahvista
settings = Asetukset
xdg-entry-startup-apps-keywords = Lingmo;Startup;Application;käynnistys;sovellus;
xdg-entry-panel-keywords = Lingmo;Panel;Applet;paneeli;sovelma
xdg-entry-x11-applications-keywords = Lingmo;X11;Application;Game;Compatibility;sovellus;peli;yhteensopivuus;
xdg-entry-touchpad-keywords = Lingmo;Touchpad;Gesture;kosketuslevy;ele;
...
xdg-entry-notifications-keywords = Lingmo;Notification;Lock;ilmoitus;lukitus;
xdg-entry-keyboard-comment = Syötelähteet, vaihtaminen, erikoismerkkien syöttäminen, pikanäppäimet
xdg-entry-wired-keywords = Lingmo;Wired;LAN;Network;Connection;kiinteä;paikallisverkko;langallinen;verkko;yhteys;
xdg-entry-power = Virranhallinta ja akku
xdg-entry-dock-keywords = Lingmo;Dock;Panel;Applet;telakka;paneeli;sovelma
...
xdg-entry-system-keywords = Lingmo;System;Info;Accounts;Firmware;järjestelmä;tiedot;tilit;laiteohjelmisto;
...
xdg-entry-network-keywords = Lingmo;Network;Wireless;WiFi;VPN;verkko;langaton;erillisverkko;
...
xdg-entry-vpn-keywords = Lingmo;VPN;Network;Connection;OpenVPN;OpenConnect;verkko;yhteys;netti;
xdg-entry-time-language-keywords = Lingmo;System;Time;Date;Region;Language;järjestelmä;aika;kello;päivä;alue;kieli;
xdg-entry-input-keywords = Lingmo;Input;Keyboard;Mouse;Mice;syöte;sisääntulo;näppäimistö;hiiri;
xdg-entry-notifications-comment = Älä häiritse, lukitusnäytön ilmoitukset ja sovelluskohtaiset asetukset
xdg-entry-sound-keywords = Lingmo;Sound;Audio;Alert;Pipewire;ääni;hälytys;
xdg-entry-power-keywords = Lingmo;Power;Battery;virta;virranhallinta;akku
xdg-entry-region-language-keywords = Lingmo;Region;Language;Date;Format;Time;Locale;Localization;alue;kieli;päivä;päiväys;muotoile;muoto;aika;kello;lokaali;maa-asetus;lokalisointi;kotoistus;
xdg-entry-applications-keywords = Lingmo;Default;Application;Startup;X11;Compatibility;oletus;ohjelma;sovellus;äppi;käynnistys;yhteensopivuus
...
xdg-entry-keyboard-keywords = Lingmo;Keyboard;Input;Source;Shortcuts;näppäimistö;syöte;sisääntulo;lähde;pikanäppäimet;
xdg-entry-window-management-keywords = Lingmo;Window;Management;Tiling;Super;Key;ikkuna;ikkunanhallinta;laatoitus;laatoita;aseta;asettelu;
...
xdg-entry-mouse-keywords = Lingmo;Mouse;Acceleration;Scrolling;hiiri;kiihdytys;vieritys;skrollaus;
xdg-entry-mouse-comment = Hiiren nopeus, kiihdytys ja luonnollinen vieritys
xdg-entry-displays-keywords = Lingmo;Display;näyttö;monitori;
...
xdg-entry-a11y-keywords = Lingmo;Accessibility;A11y;Screen;Reader;Magnifier;Contrast;Color;esteettömyys;näytönlukija;ruudunluku;suurennuslasi;kontrasti;väri;
xdg-entry-about = Tietoa
xdg-entry-wallpaper-keywords = Lingmo;Wallpaper;Background;Slideshow;taustakuva;tausta;diaesitys;

...
xdg-entry-notifications-keywords = Lingmo;Notification;Verrouillage;
...
xdg-entry-dock-keywords = Lingmo;Dock;Panneau;Applet
...
xdg-entry-x11-applications-keywords = Lingmo;X11;Application;Jeu;Compatibilité;
...
xdg-entry-vpn-keywords = Lingmo;VPN;Réseau;Connexion;OpenVPN;OpenConnect;

...
xdg-entry-panel-keywords = Lingmo;Panel;Kisalkalmazás;
...
xdg-entry-x11-applications-keywords = Lingmo;X11;Alkalmazás;Játék;Támogatás;
...
xdg-entry-vpn-keywords = Lingmo;VPN;Hálózat;Kapcsolat;OpenVPN;OpenConnect;

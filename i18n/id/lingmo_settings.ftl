...
connecting = Menyambungkan鈥?disconnect = Putuskan
forget = Lupakan
...
auth-dialog = Autentikasi diperlukan
    ...
    .wifi-description = Masukkan kata sandi atau kunci enkripsi. Anda juga dapat menyambungkan dengan menekan tombol 鈥淲PS鈥?pada router.
...
enable-export = Terapkan tema saat ini ke aplikasi GNOME
    .desc = Tidak semua alat kit mendukung peralihan otomatis. Aplikasi non-LINGMO mungkin perlu dimulai ulang seletah perubahan tema.
...
orientation = Orientasi
    .standard = Standar
    .rotate-90 = Putar 90掳
    .rotate-180 = Putar 180掳
    .rotate-270 = Putar 270掳
...
keyboard-special-char = Entri Karakter Spesial
    ...
    .compose-desc = Tombol compose memungkinkan berbagai macam karakter untuk memasukkan. Untuk menggunakannya, tekan compose dan kemudian serangkaian karakter. Misalnya, tombol compose diikuti dengan C dan o akan memasukkan 漏, sedangkan tombol compose diikuti dengan a dan 鈥?akan memasukkan 谩.
...
xdg-entry-mouse-keywords = LINGMO;Tetikus;Akselerasi;Pengguliran;
xdg-entry-bluetooth-comment = Kelola perangkat Bluetooth
xdg-entry-notifications-keywords = LINGMO;Notifikasi;Kunci;
xdg-entry-startup-apps-keywords = LINGMO;Pemulaian;Aplikasi;
...
xdg-entry-wired-keywords = LINGMO;Berkabel;LAN;Jaringan;Sambungan;
xdg-entry-power = Daya & Baterai
xdg-entry-appearance-keywords = LINGMO;Aksen;Warna;Ikon;Huruf;Tema
xdg-entry-mouse = Tetikus
xdg-entry-dock-keywords = LINGMO;Dok;Panel;Applet
...
xdg-entry-x11-applications-keywords = LINGMO;X11;Aplikasi;Permainan;Kompatibilitas;
xdg-entry-displays-comment = Kelola pengaturan konfigurasi layar
xdg-entry-touchpad-keywords = LINGMO;Papan Sentuh;Gerakan;
xdg-entry-time-language = Waktu & Bahasa
xdg-entry-users = Pengguna
xdg-entry-system-keywords = LINGMO;Sistem;Info;Akun;Firmware;
xdg-entry-default-apps = Aplikasi Bawaan
xdg-entry-wireless-keywords = LINGMO;WiFi;Wi-Fi;Jaringan;Sambungan;
xdg-entry-applications-comment = Pengaturan aplikasi bawaan, aplikasi pemulaian, dan kompatibilitas aplikasi X11
xdg-entry-about-keywords = LINGMO;Tentang
xdg-entry-panel = Panel
xdg-entry-notifications = Notifikasi
xdg-entry-a11y-keywords = LINGMO;Aksesibilitas;A11y;Layar;Pembaca;Kaca Pembesar;Kontras;Warna;
xdg-entry-wireless-comment = Sambungan Wi-Fi dan profil sambungan
xdg-entry-desktop = Desktop
xdg-entry-date-time-keywords = LINGMO;Waktu;Zona;
...
xdg-entry-network-keywords = LINGMO;Jaringan;Nirkabel;WiFi;VPN;
...
xdg-entry-workspaces-keywords = LINGMO;Ruang Kerja;Orientasi;Ikhtisar;Monitor;
...
xdg-entry-wallpaper-keywords = LINGMO;Wallpaper;Latar Belakang;Tayangan Salindia;
xdg-entry-users-keywords = LINGMO;Pengguna;Akun;
xdg-entry-about-comment = Nama perangkat, informasi perangkat keras, bawaan sistem operasi
xdg-entry-vpn-keywords = LINGMO;VPN;Jaringan;Sambungan;OpenVPN;OpenConnect;
xdg-entry-appearance-comment = Warna aksen dan tema
xdg-entry-time-language-keywords = LINGMO;Sistem;Waktu;Tanggal;Wilayah;Bahasa;
xdg-entry-input-keywords = LINGMO;Masukan;Papan Ketik;Tetikus;Tetikus;
xdg-entry-comment = Aplikasi pengaturan untuk desktop LINGMO
...
xdg-entry-sound-keywords = LINGMO;Suara;Audio;Peringatan;Pipewire;
xdg-entry-power-keywords = LINGMO;Daya;Baterai
xdg-entry-default-apps-keywords = LINGMO;Bawaan;Aplikasi
xdg-entry-keywords = LINGMO;Pengaturan;
xdg-entry-region-language-keywords = LINGMO;Wilayah;Bahasa;Tanggal;Format;Waktu;Lokal;Lokalisasi;
xdg-entry-about = Tentang
xdg-entry-input = Perangkat Masukan
xdg-entry-applications-keywords = LINGMO;Bawaan;Aplikasi;Pemulaian;X11;Kompatibilitas
...
xdg-entry-keyboard-keywords = LINGMO;Papan Ketik;Masukan;Sumber;Pintasan;
xdg-entry-vpn-comment = Sambungan VPN dan profil sambungan
xdg-entry-appearance = Tampilan
xdg-entry-window-management-keywords = LINGMO;Jendela;Pengelolaan;Pengubinan;Super;Tombol;
...
xdg-entry-displays-keywords = LINGMO;Layar;

...
xdg-entry-dock-keywords = COSMIC;Adekkan;Agalis;Tapple�?
...
xdg-entry-vpn-keywords = Lingmo;VPN;Aẓeṭṭa;Tuqqna;OpenVPN;OpenConnect;
...
xdg-entry-x11-applications-keywords = Lingmo;X11;Asnas;Urar;Amṣada;
...
xdg-entry-displays-comment = Sefrek iɣewwaṛen n twila n ubeqqe�?
...
xdg-entry-displays-keywords = COSMIC;Abeqqe�?
xdg-entry-region-language = Tamnaḍt akked Tutlayt
xdg-entry-notifications-keywords = COSMIC;Alɣu;Asekke�?
xdg-entry-power = Tazmart akked uẓru
xdg-entry-panel-keywords = COSMIC;Agalis;Tapple�?
...
forget-dialog = Ttu aẓeṭṭa-agi Wi-Fi?
    .description = Ilaq ad tsekceme�?awal uffir tikkelt-nniḍen i useqdec n uẓeṭṭa-agi Wi-Fi ɣer zdat.
identity = Tamagit
...
container-background = Agilal n umagbar
    .desc-detail = Ini n ugilal n umagbar yettwaseqdec i ufeggag adisan n tunigin, leqje�?n yidis, idiwenniyen akked yiwiǧiten am wigi. S wudem amezwer, ini n ugilal n umagbar yettwasuddem-d s wudem awurman seg ugilal n usfaylu.
    .reset = Ales awennez ɣer uwarman
    .desc = Yettwaseqdec i ufeggag n yidis n yinig, leqje�?n yidis, idiwenniyen akked iwiǧiten am wigi
...
vpn-error = Tuccḍa n VPN
    ...
    .connect = Tecce�?tuqqna ɣer VPN
    .connection-editor = Amaẓrag n tuqqna ur yeddi ara
    .connection-settings = Yecce�?wawway n iɣewwaṛen i tuqqniwin turmidin
    .updating-state = Yecce�?uleqqem n waddad n umsefrak n uzeṭṭa
    ...
    .wireguard-device = Yecce�?usnulfu n yibenk WireGuard
    .with-password =
...
remove-connection-dialog = Kkes amaɣnu n tuqqna?
    .vpn-description = Yessefk ad teskecme�?awal uffir tikkelt-nniḍen akken ad tesqedce�?aẓeṭṭa-agi deg yimal.
    .wired-description = Ilaq ad talse�?asnulfu n umaɣnu-agi akken ad t-tesqedce�?deg yimal.
...
auth-dialog = Asesteb yettwasra
    ...
    .wifi-description = Sekcem awal uffir neɣ tasarut n uwgelhen. Tzemre�?daɣen ad teqqne�?s usiti ɣef tqeffalt “WPS�?deg umeglay.
...
replace-shortcut-dialog = Semselsi anegzum?
    .desc = { $shortcut } yettwaseqdec sɣur { $name }. Ma tsemselsi�?t, { $name } ad yettwsens.
...
manage-windows = Sefrek isfuyla
    ...
    .toggle-sticky = Rmed/Sens asfaylu usbi�?
...
disable-while-typing = Sens ticki tettaru�?
...
battery = Aẓru
    ...
    .less-than-minute = Ur tettawe�?ara tesdat
    .and = akked
    .remaining-time =
        { $time } alamma { $action ->
            [full] yeččur
...
dialog = Tanaka n udiwenni
    .title = Eǧǧ iɣewwaren-agi n ubeqqe�?
...
workspaces-behavior = Tiddin n tallunt n umahil
    ...
    .fixed = Amḍan usbi�?n tallunin n umahil
...
focus-navigation = Asaḍas n yinig
    ...
    .cursor-follows-focus = Taḥnacca�?teḍfer asaḍas
...
startup-apps = Isnasen n usekker
    .add = Rnu asnas
    .user = Isnasen ttwasnekren mi ara tkecme�?
...
time-format = Amasal n uzemz akked usrag
    ...
    .show-date = Sken azemz deg tapple�?n wakud
    .friday = Sem
    .saturday = Sed
    .sunday = Acer
    .monday = Arim
...
time-date = Azemz akked wakud
    ...
    .auto-ntp = Azemz akked wakud ad ttwaleqqmen s wudem awurman ticki ara tesbadu�?tamnaḍt n wakud
...
switch-workspaces = Senfel tallunin n umahil
    .horizontal = Aḍummu n ku�?n yiḍudan ɣer zelma�?yefus
    .vertical = Aḍummu n ku�?n yiḍudan ɣer usawen/ukessar
...
click-behavior = Tiddin n usiti
    .click-finger = Asiti wis sin s sin iḍudan akked d usiti alemmas s kra�?n yiḍudan

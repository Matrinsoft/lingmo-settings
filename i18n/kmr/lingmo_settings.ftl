...
xdg-entry-x11-applications-keywords = Lingmo;X11;Sepan;Lîstik;Lihevhatin;
xdg-entry-displays-comment = Sazkariyên rêkxistinê yên dîmenderê bi rê ve bibe
xdg-entry-touchpad-keywords = Lingmo;Touchpad;Tevger;
...
xdg-entry-vpn-keywords = Lingmo;VPN;Tor;Girêdan;OpenVPN;OpenConnect;
users = Bikarhêner
    .admin = Rêveber
    .standard = Standard

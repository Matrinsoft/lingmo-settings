...
xdg-entry-panel-keywords = Lingmo;Panel;Aplet
...
xdg-entry-x11-applications-keywords = Lingmo;X11;Aplikacje;Gry;Zgodność;
xdg-entry-touchpad-keywords = COSMIC;Gładzik;Gesty;
xdg-entry-system-keywords = Lingmo;System;Informacje;Konta;Firmware;Mikrooprogramowanie;
...
xdg-entry-vpn-keywords = Lingmo;VPN;Sieć;Połączenie;OpenVPN;OpenConnect;
xdg-entry-time-language-keywords = Lingmo;System;Czas;Data;Region;Język;
...
xdg-entry-region-language-keywords = Lingmo;Region;Język;Data;Format;Czas;Ustawienia Regionalne;Położenie;Lokalizacja;

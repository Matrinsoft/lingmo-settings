...
xdg-entry-mouse-keywords = Lingmo;Mouse;Aceleração;Rolagem;
...
xdg-entry-wired-keywords = Lingmo;Wired;Cabeada;LAN;Rede;Conexão;
...
xdg-entry-desktop-keywords = Lingmo;Desktop;Área;Trabalho;
...
xdg-entry-wallpaper-keywords = Lingmo;Wallpaper;PapelParede;Background;Slideshow;Transição;Plano;Fundo;
...
xdg-entry-vpn-keywords = Lingmo;VPN;Rede;Conexão;OpenVPN;OpenConnect;

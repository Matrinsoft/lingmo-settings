...
xdg-entry-x11-applications-keywords = Lingmo;X11;Иксы;Приложение;Игра;Совместимость;
...
xdg-entry-bluetooth-keywords = Lingmo;Bluetooth;Блютуз;
...
xdg-entry-vpn-keywords = Lingmo;VPN;ВПН;Сеть;Подключение;OpenVPN;OpenConnect;

...
xdg-entry-mouse-keywords = Lingmo;Mouse;Acceleration;Scrolling;Космик;миш;убрзање;помицање;Kosmik;miš;ubrzanje;pomicanje;
xdg-entry-bluetooth-comment = Управљај Блутут уређајима
xdg-entry-notifications-keywords = Lingmo;Notification;Lock;Космик;обавештење;закључавање;Kosmik;obaveštenje;zaključavanje;
xdg-entry-startup-apps-keywords = Lingmo;Startup;Application;Космик;Покретање;Програм;kosmik;pokretanje;program;
...
xdg-entry-wired-keywords = Lingmo;Wired;LAN;Network;Connection;Космик;Жичана;ЛАН;Мрежа;Веза;kosmik;žičana;lan;mreža;veza;
...
xdg-entry-mouse = Миш
xdg-entry-dock-keywords = Lingmo;Dock;Panel;Applet;Космик;Док;Окно;Програмчић;kosmik;dok;okno;programčić
bluetooth = Блутут
...
firmware = Фирмвер
xdg-entry-panel-keywords = Lingmo;Panel;Applet;Космик;површ;програмчић;Kosmik;površ;programčić
...
xdg-entry-desktop-keywords = Lingmo;Desktop;Космик;Радна површина;kosmik;radna površina;
...
xdg-entry-x11-applications-keywords = Lingmo;X11;Application;Game;Compatibility;Космик;Икс-11;Програм;Игрица;Усаглашеност;kosmik;iks-11;program;igrica;usaglašenost;
xdg-entry-displays-comment = Управљај подешавањима поставки екрана
xdg-entry-touchpad-keywords = Lingmo;Touchpad;Gesture;Космик;додирна табла;гест;Kosmik;dodirna tabla;gest;
xdg-entry-time-language = Време и језик
xdg-entry-users = Корисници
window-management = Управљање прозорима
xdg-entry-system-keywords = Lingmo;System;Info;Accounts;Firmware;Космик;Систем;Подаци;Налози;Фирмвер;kosmik;sistem;podaci;nalozi;firmver;
...
dock = Док
xdg-entry-about-keywords = Lingmo;About;Космик;О програму;Kosmik;O programu
...
xdg-entry-a11y-keywords = Lingmo;Accessibility;A11y;Screen;Reader;Magnifier;Contrast;Color;Космик;Приступачност;Екран;Читач;Лупа;Контраст;Боја;kosmik;pristupačnost;ekran;čitač;lupa;kontrast;boja;
xdg-entry-wireless-comment = Бежичне везе и профили везе
xdg-entry-desktop = Радна површина
xdg-entry-date-time-keywords = Lingmo;Time;Zone;Космик;Време;Зона;kosmik;vreme;zona;
...
xdg-entry-bluetooth-keywords = Lingmo;Bluetooth;Космик;Блутут;kosmik;blutut;
about = О систему
input-devices = Улазни уређаји
xdg-entry-dock-comment = Необавезна трака за апликације и програмчиће
xdg-entry-network-keywords = Lingmo;Network;Wireless;WiFi;VPN;Космик;мрежа;бежична веза;бежична;ВПН;Kosmik;mreža;bežična veza;bežična;vpn;
...
panel = Трака
xdg-entry-wallpaper-keywords = Lingmo;Wallpaper;Background;Slideshow;Космик;позадина;позадина;покретни приказ;Kosmik;pozadina;pozadina;pokretni prikaz;
...
xdg-entry-vpn-keywords = Lingmo;VPN;Network;Connection;OpenVPN;OpenConnect;Космик;ВПН;мрежа;веза;ОпенВПН;ОпенКонект;kosmik;vpn;mreža;veza;openvpn;openkonekt;
users = Корисници
    .admin = Админ
    .standard = Обичан
    .profile-add = Изаберите слику профила
xdg-entry-appearance-comment = Боје нагласка и теме
xdg-entry-time-language-keywords = Lingmo;System;Time;Date;Region;Language;Космик;систем;време;датум;област;језик;Kosmik;sistem;vreme;datum;oblast;jezik;
xdg-entry-input-keywords = Lingmo;Input;Keyboard;Mouse;Mice;Космик;Унос;Тастатура;Миш;Мишеви;kosmik;unos;tastatura;miš;miševi;
...
xdg-entry-sound-keywords = Lingmo;Sound;Audio;Alert;Pipewire;Космик;Звук;Аудио;Упозорење;Пајпвајер;kosmik;zvuk;audio;upozorenje;pajpvajer;
xdg-entry-power-keywords = Lingmo;Power;Battery;Космик;Напајање;Батерија;kosmik;napajanje;baterija
legacy-applications = Усаглашеност програма Икс-11
xdg-entry-default-apps-keywords = Lingmo;Default;Application;Космик;Подразумевано;Програм;kosmik;podrazumevano;program
xdg-entry-keywords = Lingmo;Settings;Космик;Подешавања;kosmik;podešavanja;
xdg-entry-region-language-keywords = Lingmo;Region;Language;Date;Format;Time;Locale;Localization;Космик;Регион;Језик;Датум;Формат;Време;Локалитет;Локализација;kosmik;region;jezik;datum;format;vreme;lokalitet;lokalizacija;
xdg-entry-about = О програму
xdg-entry-input = Улазни уређаји
xdg-entry-applications-keywords = Lingmo;Default;Application;Startup;X11;Compatibility;Космик;Подразумевано;Програм;Покретање;Икс-11;Усаглашеност;kosmik;podrazumevano;program;pokretanje;iks-11;usaglašenost
...
xdg-entry-keyboard-keywords = Lingmo;Keyboard;Input;Source;Shortcuts;Космик;тастатура;унос;извор;пречице;Kosmik;tastatura;unos;izvor;prečice;
xdg-entry-vpn-comment = ВПН везе и профили везе
keyboard = Тастатура
xdg-entry-appearance = Изглед
xdg-entry-window-management-keywords = Lingmo;Window;Management;Tiling;Super;Key;Космик;Прозор;Управљање;Поплочавање;Супер;Тастер;kosmik;prozor;upravljanje;popločavanje;super;taster;
...
xdg-entry-displays-keywords = Lingmo;Display;Космик;Екран;kosmik;ekran;
time = Време и језик

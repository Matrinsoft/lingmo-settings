...
xdg-entry-dock-keywords = Lingmo;Docka;Panel;Applet;Miniprogram
...
xdg-entry-panel-keywords = Lingmo;Panel;Applet;Miniprogram
xdg-entry-time-language-comment = Hantera systemets datum, tid, region och språk
xdg-entry-x11-applications-keywords = Lingmo;X11;Program;Spel;Kompatibilitet;
xdg-entry-touchpad-keywords = COSMIC;Pekplatta;Gest;
xdg-entry-system-keywords = Lingmo;System;Info;Konton;Fast programvara;
...
xdg-entry-vpn-keywords = Lingmo;VPN;Nätverk;Anslutning;OpenVPN;OpenConnect;
xdg-entry-time-language-keywords = Lingmo;System;Tid;Datum;Region;Språk;
xdg-entry-sound-keywords = COSMIC;Ljud;Ljud;Varning;Pipewire;
xdg-entry-power-keywords = COSMIC;Ström;Batteri
xdg-entry-region-language-keywords = Lingmo;Region;Språk;Datum;Format;Tid;Lokal;Lokalisering;

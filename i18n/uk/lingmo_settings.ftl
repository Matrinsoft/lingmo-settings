...
auth-dialog = Авторизація обов’язков�?
    .vpn-description = Введіть ім’�?користувача та пароль, необхідні для служби VPN.
    .wifi-description = Введіть пароль або ключ шифрування. Також можна під’єднатис�?через кнопку «WPS» на маршрутизаторі.
...
remove-connection-dialog = Вилучити профіль з’єднанн�?
    .vpn-description = Щоб скористатися цією мережею знову, вам потрібно буде повторно ввести пароль.
    .wired-description = Щоб скористатися цим з’єднання�?знову, вам потрібно буде створити цей профіль повторно.
vpn = VPN
...
vpn-error = Помилка VPN
    ...
    .connect = Не вдалося з’єднатис�?з VPN
    .connection-editor = Помилка редактора з’єднан�?
    .connection-settings = Не вдалося отримати налаштування активних з’єднан�?
...
bluetooth-paired = З’єднан�?у минулому пристрої
    .connect = З’єднат�?
...
sound-device-port-unplugged = Від’єднан�?
...
xdg-entry-dock-comment = Необов’язков�?область для панелі застосунків і віджетів
...
xdg-entry-network-comment = Керуйте мережевими з’єднанням�?
...
xdg-entry-wired-comment = Дротове з’єднанн�?і профілі з’єднан�?
...
xdg-entry-x11-applications-keywords = Lingmo;X11;Застосунок;Програма;Гра;Сумісність;КОСМІК;КОСМОС;КОСМІЧНЕ;
...
xdg-entry-vpn-keywords = Lingmo;VPN;Мережа;З'єднання;Підключення;OpenVPN;OpenConnect;КОСМІК;КОСМОС;КОСМІЧНЕ;
...
xdg-entry-bluetooth-keywords = Lingmo;Bluetooth;Блютуз;Бездротове;З’єднанн�?КОСМІК;КОСМОС;КОСМІЧНЕ;

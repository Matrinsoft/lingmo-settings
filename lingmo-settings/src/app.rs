...
use lingmo_settings_page::{self as page, section};
#[cfg(feature = "wayland")]
use desktop::{
    dock,
...
impl cosmic::Application for SettingsApp {
	...
	const APP_ID: &'static str = "com.lingmoos.LingmoSettings";
    ...
    fn subscription(&self) -> Subscription<Message> {
        ...
        let subscriptions = vec![
            ...
            #[cfg(feature = "wayland")]
            self.core()
                .watch_config::<CosmicPanelConfig>("com.lingmoos.LingmoPanel.Panel")
                .map(|update| {
            ...
            #[cfg(feature = "wayland")]
            self.core()
                .watch_config::<CosmicPanelConfig>("com.lingmoos.LingmoPanel.Dock")
                .map(|update| {
                    for why in update.errors {

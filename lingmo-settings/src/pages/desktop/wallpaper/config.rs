...
use lingmo_settings_wallpaper as wallpaper;
use std::collections::VecDeque;
use std::env;
use std::path::{Path, PathBuf};

const NAME: &str = "com.lingmoos.LingmoSettings.Wallpaper";
const VERSION: u64 = 1;
...
impl Config {
    pub fn new() -> Self {
        ...
        let state = match cosmic_config::Config::new_state("com.lingmoos.LingmoBackground", VERSION)
        {
            Ok(state) => state,
            Err(why) => {

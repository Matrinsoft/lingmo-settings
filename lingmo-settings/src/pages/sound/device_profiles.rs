...
pub enum Message {
    ...
    Model(lingmo_settings_sound::Message),
...
impl page::Page<crate::pages::Message> for Page {
    ...
    fn set_id(&mut self, entity: lingmo_settings_page::Entity) {
        self.entity = entity;
    }
        ...
        iced::Subscription::run(|| {
            iced::stream::channel(
                ...
                move |emitter: futures::channel::mpsc::Sender<crate::pages::Message>| async move {
                    lingmo_settings_sound::subscribe(emitter, |m| Message::Model(m).into()).await
                },
            )
        })
    }
...
impl Page {
    pub fn update(&mut self, message: Message) -> cosmic::Task<crate::app::Message> {
        match message {
            Message::Model(lingmo_settings_sound::Message::Subscription(message)) => {
                self.model.update(message);
            }

            Message::Model(lingmo_settings_sound::Message::Client(client)) => {
